...
\textit{Tech: Python, Transformers, RetellAI, Pipecat, AssemblyAI, LLM-based conversational AI, LangFuse, conversation evaluation for hallucination mitigation, information extraction from transcripts, and pipelines for aggregating and analyzing conversations.}
...
\textit{Tech: Go, Python, Kubernetes, Docker, IaaC, video streaming} 
...
\textit{Tech: Python, Transformers, large-scale data pipelines (Google DataFlow) processing tens of millions of images, Cloud Run, Image Classification, Kubernetes.} 
\end{itemize}
