...
\textbf{Principal AI Engineer} \hfill San Francisco, CA\\
\textit{HaloVision Inc.} \hfill Jan 2025 -- Jul 2025
\vspace{0.5em}

Led development of \textbf{HaloVision}, an \textbf{AI-driven confidential conversation analytics platform} built to help organizations surface hidden blockers, communication breakdowns, and sentiment trends across teams.  
...
\textbf{Senior AI/ML Engineer} \hfill Sept 2021 -- Dec 2024 \\
\textit{Azumio Inc.} \hfill \href{https://www.azumio.com/solutions/food-lens/overview}{Food Lens}

\vspace{0.5em}

Built and deployed \textbf{Food Lens AI} at \textbf{Azumio}, a leading mobile health and wellness company whose biometric products—such as heart-rate monitoring and fitness-tracking apps—have helped millions of users take control of their health.  
Food Lens extended this mission by addressing a critical challenge: enabling people to accurately recognize foods from photos and receive instant nutritional feedback to make informed dietary decisions.  
...
Engineered a distributed \textbf{data-ingestion and training pipeline} using \textbf{Google DataFlow} (GPU-enabled) and \textbf{Cloud Storage} to orchestrate the entire data life-cycle.  
Used \textbf{Pandas} and \textbf{BigQuery} to clean and de-duplicate unlabeled datasets, spun up transient Google DataFlow workers for embedding generation, and employed custom \textbf{image-classification micro-models} for label detection (front/back/barcode/nutrition panels).  
...
\textbf{Director of Engineering} \hfill Aug 2019 -- Sept 2021 \\
\textit{Chrysalis Cloud} \hfill \href{https://www.crunchbase.com/organization/chrysalis-cloud}{Chrysalis Cloud}

\vspace{0.5em}

Architected, designed, and developed all backend services for \textbf{Chrysalis Cloud}, a distributed \textbf{video-streaming and ML inference framework} built to make large-scale video ingestion and analysis \textbf{simple, fast, and up to 60× cheaper} than AWS Kinesis.  
...
\textbf{Senior Backend Engineer} \hfill Aug 2018 -- Aug 2019 \\
\textit{Wearless Tech Inc.} \hfill \href{https://www.crunchbase.com/organization/cocoon-cam}{Cocooncam}

\vspace{0.5em}

Served as \textbf{Lead Backend Engineer} for \textbf{CocoonCam}, an \textbf{AI-powered baby monitor} platform that used computer vision for real-time motion and breathing detection.  
...
\textbf{Senior Backend Engineer} \hfill Feb 2014 -- Aug 2018 \\
\textit{Azumio Inc.} \hfill \href{https://azumio.com}{Health & Wellness AI Platform}

\vspace{0.5em}
At Azumio, I architected and scaled backend systems powering AI-driven health, fitness, and nutrition applications—used by tens of millions of users worldwide. I've designed and maintained high-throughput NoSQL database (Google Datastore) for storing biometric and nutrition data at scale. Integrated these with Google BigQuery for analytics, cohort analysis, and user behavior insights across hundreds of millions of records.
\vspace{0.5em}
Optimized performance and reliability, built caching and batch-processing systems to handle 10K+ requests per second with sub-100 ms latency while ensuring data consistency and uptime across global regions.
\vspace{0.5em}
Ensured data privacy and security compliance; Applied encryption at rest/in transit and anonymization techniques to meet GDPR- and HIPAA-aligned data handling standards.

\textbf{Links}:
\begin{itemize}
    \item \href {https://pmc.ncbi.nlm.nih.gov/articles/PMC6592896/}{https://pmc.ncbi.nlm.nih.gov/articles/PMC6592896/}
    \item \href {https://www.researchgate.net/figure/Azumio-Instant-Heart-Rate-capture-screen_fig1_305663641}{https://www.researchgate.net/figure/Azumio-Instant-Heart-Rate-capture-screen_fig1_305663641}
    \item \href {https://covidresearch.ucsf.edu/projects/analysis-azumio-stepcount-heart-rate-and-deidentified-data-covid-19}{https://covidresearch.ucsf.edu/projects/analysis-azumio-stepcount-heart-rate-and-deidentified-data-covid-19}
    \item \href {https://www.researchgate.net/publication/333580586_Best_practices_for_analyzing_large-scale_health_data_from_wearables_and_smartphone_apps}{Best practices for analyzing large-scale health data from wearables and smartphone apps}
\end{itemize}
...
\section*{Other Publications \& Projects 2006 -- 2014}
\begin{itemize}
    \item \textbf{Phaidra} - Advanced automation of academic library system and University repository system
    
    \item \textbf{Motor Vehicle Registry of Slovenia} Worked with Ministry of the Interior as a developer
    
    \item \textbf{Pfizer} - mobile application for Pfizer’s field sales representatives to support biopharmaceutical product promotion and doctor engagement 


    \item \textbf{Stanford researchers find intriguing clues about obesity by counting steps via smartphones} \href {https://news.stanford.edu/stories/2017/07/stanford-researchers-find-intriguing-clues-obesity-counting-steps-via-smartphones} {Staford report}

    \item \textbf{Countrywide natural experiment links built environment to physical activity} \href{https://www.nature.com/articles/s41586-025-09321-3}{Nature Article}

    \item \textbf{Comparing Two Commercially Available Diabetes Apps to Explore Challenges in User Engagement: Randomized Controlled Feasibility Study} \href{https://formative.jmir.org/2021/6/e25151/}{Research paper}

    \item \textbf{Usability Evaluation of Four Top-Rated Commercially Available Diabetes Apps for Adults With Type 2 Diabetes} \href{https://pmc.ncbi.nlm.nih.gov/articles/PMC7710160/} {Researh paper}
